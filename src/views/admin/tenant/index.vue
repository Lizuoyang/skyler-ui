                ...
                <el-form :model="state.queryForm" ref="queryRef" :inline="true" @keyup.enter="getDataList">
                    ...
                    <el-form-item :label="$t('tenant.status')" prop="status">
                        <el-select v-model="state.queryForm.status" :placeholder="$t('tenant.inputStatusTip')">
                          <el-option :key="item.id" :label="item.label" :value="item.value" v-for="item in status_type" />
                        </el-select>
                    </el-form-item>
                    <el-form-item>
            ...
            <el-table :data="state.dataList" v-loading="state.loading" border
                ...
                <el-table-column prop="status" :label="$t('tenant.status')" show-overflow-tooltip>
                    <template #default="scope">
                        <el-switch v-model="scope.row.status" @change="changeSwitch(scope.row)" :active-value="0"
                ...
                <el-table-column :label="$t('common.action')" width="150">
                    <template #default="scope">
                        ...
                        <el-button icon="delete" text type="primary" v-auth="'admin_tenant_del'"
...
<script setup lang="ts" name="systemSysTenant">
    ...
    import {fetchList, delObjste, putObj} from "/@/api/admin/tenant";
