      ...
      <el-row>
        <div class="mb8" style="width: 100%">
          <el-button icon="folder-add" type="primary" class="ml10" @click="formDialogRef.openDialog()"
            v-auth="'admin_tenantPackge_add'">
            {{ $t('common.addBtn') }}
          </el-button>
          <el-button plain :disabled="multiple" icon="Delete" type="primary"
            v-auth="'admin_tenantPackge_del'" @click="handleDelete(selectObjs)">
            {{ $t('common.delBtn') }}
          </el-button>
          <right-toolbar v-model:showSearch="showSearch" :export="'admin_tenantPackge_export'"
      ...
      <el-table :data="state.dataList" v-loading="state.loading" border
        ...
        <el-table-column :label="$t('common.action')" width="150">
          <template #default="scope">
            ...
            <el-button icon="delete" text type="primary" v-auth="'admin_tenantPackge_del'" @click="handleDelete([scope.row.id])">{{ $t('common.delBtn') }}</el-button>
          </template>
        </el-table-column>
      </el-table>
...
// 导出excel
const exportExcel = () => {
  downBlobFile('/admin/tenantPackge/export',Object.assign(state.queryForm, { ids: selectObjs }), 'tenantPackge.xlsx')
}
